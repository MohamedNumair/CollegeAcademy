...
|  | |
|---:|----------------------|
| {{% button href="/Prep/files/Diff-Future-LHopital.pdf" icon="fas fa-download" %}}COLLEGE DOWNLOAD{{% /button %}} | سنتر فيوتشر- قاعدة لوبيتال - م الشافعي|
| {{% button href="/Prep/files/Diff-Future-TaylorExpansion.pdf" icon="fas fa-download" %}}COLLEGE DOWNLOAD{{% /button %}} | سنتر فيوتشر- مفكوك تايلور - م الشافعي|
